...
import com.sriram_n.foodmartserver.Model.Category;
import com.sriram_n.foodmartserver.Model.Food;
import com.sriram_n.foodmartserver.ViewHolder.FoodViewHolder;
        ...
        alertDialog.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                if(newFood !=  null)
                {
                    ...
                    Snackbar.make(rootLayout,"Món ăn "+newFood.getName()+" đã được thêm", Snackbar.LENGTH_SHORT).show();
                }
            }
        });
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(FoodList.this,"Tải hình ảnh!", Toast.LENGTH_SHORT).show();
        ...
        alertDialog.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                dialog.dismiss();
                    ...
                    Snackbar.make(rootLayout,"Món ăn "+item.getName()+" đã được cập nhật", Snackbar.LENGTH_SHORT).show();
            }
        });
        ...
        if(saveUri != null)
        {
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(FoodList.this,"Cập nhật!", Toast.LENGTH_SHORT).show();
                            imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                @Override
                                public void onSuccess(Uri uri) {
