    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (order != null) {
                    int quantity = Integer.parseInt(order.getQuantity()) + Integer.parseInt(numberButton.getNumber());
        ...
        if (!foodId.isEmpty()) {
            if (Common.isConnectedToInternet(getBaseContext()))
                ...
                Toast.makeText(FoodDetail.this, "Vui lòng kiểm tra kết nối của bạn!", Toast.LENGTH_SHORT).show();
                return;
            }
        }
    ...
    private void getDetailFood(String foodId) {
        foods.child(foodId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                food_price.setText(Common.formatPrice(price));
