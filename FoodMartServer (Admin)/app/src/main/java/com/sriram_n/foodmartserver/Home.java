...
import com.sriram_n.foodmartserver.Service.ListenOrder;
import com.sriram_n.foodmartserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
        ...
        alertDialog.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                if(newCategory !=  null)
                {
                    ...
                    Snackbar.make(drawer,"Danh mục mới "+newCategory.getName()+" đã được thêm", Snackbar.LENGTH_SHORT).show();
                }
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
            ...
            && data!= null && data.getData() != null)
        {
            ...
            btnSelect.setText("Chọn hỉnh ảnh");
        }
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.nav_users){
            Intent users = new Intent(Home.this, UserStatus.class);
            startActivity(users);
        }
